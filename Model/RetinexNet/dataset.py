...
def get_dataset_len(route, phase):
    if phase == 'train':
        ...
        low_data_names = glob(route + 'our485' + '/low/*.png')
        high_data_names = glob(route + 'our485' + '/high/*.png')
        low_data_names.sort()
...
class TheDataset(data.Dataset):
    ...
    def __init__(self, route='/home/xuhang/dataset/LOLdataset/', phase='train', patch_size=48):
        self.route = route
        self.phase = phase
